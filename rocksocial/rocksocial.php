...
// fix for the W3 Total Cache bug (fixed in Rocksocial 5.1)
...
function integrateFloatingButtonsIntoWpContent($dd_floating_button_for_display,$content,$ddFloatDisplay){
	...
	if($floatButtonsContainer != DD_EMPTY_VALUE){
		...
		$floatingJS = '<script type="text/javascript" src="' . DD_PLUGIN_URL . '/js/floating-bar.js?ver=' . DD_VERSION . '"></script>';
...
function dd_admin_init_setting() {
	...
	wp_register_style('dd_admin_style', DD_PLUGIN_URL . '/css/style-admin.css');
}
