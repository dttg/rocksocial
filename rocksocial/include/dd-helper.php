...
function dd_wp_enqueue_styles() {
	wp_enqueue_style( 'rocksocial', plugins_url( 'css/style.css', dirname( __FILE__ ) ), array(), DD_VERSION, 'screen' );
}
...
function dd_check_version(){
	...
	$exit_msg="<div id='errmessage' class='error fade'><p>Rocksocial requires WordPress 2.3 or newer. <a href='http://codex.wordpress.org/Upgrading_WordPress'>Please update!</a></p></div>";
