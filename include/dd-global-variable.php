...
define('DD_NAME','Rocksocial');
define('DD_VERSION','5.3.6');
define('DD_DISABLED', '<!-- Rocksocial Disabled -->');

define('DD_AUTHOR_SITE', '<!-- Social Buttons Generated by Rocksocial plugin v5.3.6,
    Author : Rocksocial
    Website : http://marketingdeconteudo.com/rocksocial -->');

define('DD_FORM_SAVE','rocksocial_save');
define('DD_FORM_CLEAR','rocksocial_clear');
define('DD_FORM_CLEAR_ALL','rocksocial_clear_all');
define('DD_FORM','rocksocial_form');
...
/****************************************
 * Rocksocial Global Display (Start)
 *******/
...
/*******
 * Rocksocial Global Display (End)
 ****************************************/

/****************************************
 * Rocksocial Normal Display (Start)
 *******/
...
/*******
 * Rocksocial Normal Display (End)
 ****************************************/

/****************************************
 * Rocksocial Floating Display (Start)
 *******/
define('FLOAT_BUTTON_CREDIT_LINK', '<div id=\'dd_name\'><a href=\'http://marketingdeconteudo.com/rocksocial\' target=\'_blank\'>Rocksocial</a></div>');

define('DD_FLOAT_OPTION', 'dd_float_option');
define('DD_FLOAT_OPTION_CREDIT','dd_float_option_credit');
define('DD_FLOAT_OPTION_CREDIT_VALUE',true);
...
/*******
 * Rocksocial Floating Display (End)
 ****************************************/
?>