...
function dd_page_for_normal_display(){
	...
	if (isset($_POST[DD_FORM_SAVE]) && check_admin_referer('rocksocial_normal_save','rocksocial_normal_nonce')) {
	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			...
			name="<?php echo DD_FORM_CLEAR; ?>" value="Reset Normal Display Settings" type="submit" style="width:200px;"/>
					...
					<?php wp_nonce_field('rocksocial_normal_save','rocksocial_normal_nonce'); ?>
				</form>					
			</div>
		</div>
	</div>
