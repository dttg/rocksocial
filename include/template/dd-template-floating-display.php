...
function dd_page_for_floating_display(){
	...
	if (isset($_POST[DD_FORM_SAVE]) && check_admin_referer('rocksocial_floating_save','rocksocial_floating_nonce')) {
	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		...
		<div id="post-body">
			...
			<?php echo ($ddFloatDisplay[DD_FLOAT_OPTION][DD_FLOAT_OPTION_CREDIT]==DD_DISPLAY_ON) ? DD_CHECK_BOX_ON : DD_CHECK_BOX_OFF ?>>
					...
					<?php wp_nonce_field('rocksocial_floating_save','rocksocial_floating_nonce'); ?>
				</form>
